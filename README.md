...
Versioned documentation site with search, sidebar navigation, and Starlight integration.

**Stack:** Astro | **Complexity:** simple
**Tags:** `docs`, `documentation`, `astro`, `starlight`, `search`
